...
const HeaderContents = () => {
    return (
        ...
        <div className='row main-div' >
            <div className='left-image col-md-6 text-center mt-5 text-white'>
            ...
            <div className='right-text col-md-6'>
                ...
                <button type="button" class="text-white my-btn btn btn btn-outline-primary mx-3">Hire me</button> 
                
                <button type="button" class="text-white my-btn my-btn btn btn btn-outline-primary">Contact me</button>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fill-opacity="1" d="M0,32L80,74.7C160,117,320,203,480,202.7C640,203,800,117,960,69.3C1120,21,1280,11,1360,5.3L1440,0L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
        </div>
    );
};
