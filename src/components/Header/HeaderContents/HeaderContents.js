                ...
                <div className='right-text '>
                    <div className='my-intro-text pt-5 p-3'>
                        ...
                        <ul className="my-li-group d-flex">
                            <li className="my-li mr-5" style={{ fontSize: '18px', fontWeight: '700' }}> <span className='li-text'>Web Developer</span> </li>

                            <li className="my-li" style={{ fontSize: '18px', fontWeight: '700' }}> <span className='li-text'>Python Programmer</span>  </li>
                        </ul>
                        ...
                        <div className='text-center'>
                            <a href={'https://www.github.com/farukhrana14'}> <FontAwesomeIcon icon={faGithub} style={{ fontSize: '30px', color: '#0099ff' }} /> </a>
                            <a href={'https://www.linkedin.com/in/anmfarukh/'}><FontAwesomeIcon icon={faLinkedinIn} className='mx-3' style={{ fontSize: '30px', color: '#0099ff' }} /></a>
                        </div>
                    ...
                    <div className='my-button text-center'>
                        ...
                        <a href={'#contact-form'}><button type="button" className="text-white my-btn my-btn btn btn btn-outline-primary mb-1">Contact me</button></a>
